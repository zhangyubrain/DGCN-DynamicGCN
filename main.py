...
def main():
    ...
    parser.add_argument('--matroot', type=str, default=r'E:\OPT\research\fMRI\myModel\comparsion\population-gcn-master\all.csv',
                        help='root directory of the subject ID')
